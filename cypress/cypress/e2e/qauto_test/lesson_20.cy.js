...
describe('Registration form validation tests', () => {
    ...
    it('Check the Name "empty field" validation', () => {
        ...
        registrationForm.verifyFieldErrorMessageIsVisible(
            'nameInput',
            'Name required',
        );
        registrationForm.verifyFieldBorderColor(
            'nameInput',
            'rgb(220, 53, 69)',
        );
    ...
    it('Check the "Email is incorrect" validation', () => {
        ...
        registrationForm.fillInputField(
            'emailInput',
            'inva lidemail@gmail.com',
        );
        registrationForm.verifyFieldErrorMessageIsVisible(
            'emailInput',
            'Email is incorrect',
    ...
    it('Check the "Passwords do not match" validation', () => {
        ...
        registrationForm.verifyFieldErrorMessageIsNotVisible(
            'repeatPasswordInput',
        );
